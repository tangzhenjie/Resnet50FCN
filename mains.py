...
from SRSEGNet import Resnet50FCN
...
def train(args):
    ...
    train_set = GenerateData(image_dir=train_path, img_size=args.img_size, augment=True)
    ...
    #print(net)
    model_title = args.dataset_name + "_" + args.model_title + '_imgsize=' + str(args.img_size)
    ...
    test_set = GenerateData(image_dir=test_path, img_size=512, augment=False)
